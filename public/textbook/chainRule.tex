...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [very thick, penColor2, samples=100, smooth, domain=(.01:6)] {ln(x)};
...
\begin{mainTheorem}[The Derivative of the Natural Logrithm]\index{the derivative of the natural logarithm}
\[
\ddx \ln(x) = \frac{1}{x}.
\]
\end{mainTheorem}
