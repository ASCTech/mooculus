...
not \textbf{differentiable} at $x$. Note, if the domain of the
function is bounded on the right or left, then we only the appropriate
one-sided limit to exist for the function to be differentiable.
