...
\begin{mainTheorem}[Differenitability implies Continuity]\label{theorem:diff-cont}
...
\begin{mainTheorem}[The Power Rule]\index{derivative rules!power}\index{the power rule}
