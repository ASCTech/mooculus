...
\begin{tikzpicture}
	\begin{axis}[
	  ...
	  \addplot [very thick, penColor, smooth,domain=(-3:-.1)] {1/x};
          ...
          \node at (axis cs:1,1) [anchor=west] {\color{penColor}$f(t)$};  %%%% FIX THIS!
          \node at (axis cs:1,-.42) [anchor=west] {\color{penColor2}$f'(t)$};
        \end{axis}
\end{tikzpicture}
...
in fact is called the \textit{derivative}\index{derivative} of the
