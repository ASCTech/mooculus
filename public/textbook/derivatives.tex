...
\begin{exercise}
Let $f(x) = x^2 -4$. Use the definition of the derivative to comptute
...
\begin{exercise}
Let $f(x) = \frac{1}{x+2}$. Use the definition of the derivative to comptute
...
\]
\end{fullwidth}
While these tables don't establish a pattern, it turns out that
\[
