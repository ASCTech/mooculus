...
\begin{exercise}
$\lim_{x\to \infty} \left(17 + \frac{32}{x} - \frac{\sin(x/2)^2}{x^3}\right)$
\end{exercise}
...
f(x) = \sqrt{x-4} 
\]
Is $f(x)$ continuous at the point $x=4$?  Is $f(x)$ continuous
function on $\R$?
\end{exercise}
...
f(x) = \frac{1}{x+3}
\]
Is $f(x)$ continuous at the point $x=3$?  Is $f(x)$ continuous
function on $\R$?
\end{exercise}
...
\end{cases}
\]
Is $f(x)$ continuous at the point $x=0$?  Is $f(x)$ continuous
function on $\R$?
\end{exercise}
...
\end{cases}
\]
Is $f(x)$ continuous at the point $x=5$?  Is $f(x)$ continuous
function on $\R$?
\end{exercise}
