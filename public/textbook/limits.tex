...
\begin{answer}
  Let $\epsilon > 0$.   Pick $\delta$ so that $\delta < 1$ and $\delta < \frac{\epsilon}{61}$.  Suppose $0 < |x-4| < \delta$.  Then $4 - \delta < x < 4 + \delta$.  Cube to get $\left( 4 - \delta \right)^3 < x^3 < \left( 4 + \delta \right)^3$.  Expanding the right-side inequality, we get $x^3 < \delta^3 + 12*\delta^2 + 48*\delta + 64 < \delta + 12 \delta + 48 \delta + 64 = 64 + \epsilon$.  The other inequality is similar.
\end{answer}
\end{exercise}
