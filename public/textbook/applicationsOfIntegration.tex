...
\begin{tikzpicture}
 \begin{axis}[
  ...
  \addplot3[surf,colormap/\surfaceColorTwo,opacity=.1, %inside
  samples=10,
  samples y =20,
  domain=0:.5,y domain=0:2*pi,
  z buffer=sort]
  ...
  \addplot3[surf,colormap/\surfaceColorTwo,opacity=.1,
  samples=10,
  samples y=20,
  domain=.5:1,y domain=0:2*pi,
  z buffer=sort]
...
\begin{tikzpicture}
 \begin{axis}[
  ...
  \addplot3[surf,colormap/\sliceColor,opacity=.7,%shell
  samples=5,
  samples y = 20,
