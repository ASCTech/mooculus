...
\begin{tikzpicture}
\draw[textColor, dashed, very thick] (0,0) -- (5,4);
...
\node [above,penColor] at (3.5,4) {$p'(t) = 500$ mph};
\node [below,penColor] at (2.5,0) {$4$ miles};
\node [left,textColor] at (2.4,2) {$s(t)$ miles};
\end{tikzpicture}
...
\draw[textColor, dashed, very thick] (0,0) -- (2,0);
\node [below,penColor] at (1,0) {$r=4$ cm};
\node [penColor,left] at (-1.5,1.42) {$\dd[V]{t}$ = 7 cm$^3$/sec};
\node [penColor, right] at (1.5,-1.42) {$V = \frac{4\pi r^3}{3}$};
\end{tikzpicture}
...
\draw[penColor!50!background,very thick] (0,2) ellipse (2 and .5);
\draw[penColor, very thick] (3.97,3.85) -- (0,0);
\draw[penColor, very thick] (-3.97,3.85) -- (0,0);
\draw[penColor, very thick] (0,4) -- (4,4);
\draw[penColor!50!background, very thick] (0,2) -- (2,2);
\draw[->,line width=0.4cm, textColor!20!background] (0,6) -- (0,4.25);
\draw[->, dashed, textColor, very thick] (2.1,0) -- (2.1,2);
\draw[dashed, textColor, very thick] (-4.1,0) -- (-4.1,4);
\node[right, textColor] at (.4,5.6) {$\dd[V]{t} = 10$ cm$^3$/sec};
\node[below, penColor] at (2,4) {$10$ cm};
\node[above, penColor] at (1,2) {$r$ cm};
\node[right, textColor] at (2.1,1) {$h(t) = 4$ cm};
\node[left, textColor] at (-4.1,2) {$30$ cm};
\end{tikzpicture}
...
\draw [penColor, very thick] (0,2.3) arc [radius=.7, start angle=270, end angle= 305];
\draw[->, penColor, very thick] (0,-.12) -- (2,-.12);

\node[penColor,rotate=35] at (2.12,-.12) {\scalebox{3} \Ladiesroom};
...
\node[penColor,right,above] at (.3,2) {$\theta$};
\end{tikzpicture}
...
\draw[dashed,penColor, very thick] (3,0) -- (0,3);

\node[penColor,rotate=90,right] at (.5,3) {\scalebox{-2} \Bicycle};
\node[penColor,right] at (0,.2) {$P$};
\node[penColor,left] at (0,3) {$(0,a(t))$};
\node[penColor,below] at (3,0) {$(b(t),0)$};
\node[penColor,above] at (1.6,1.6) {$c(t)$};
