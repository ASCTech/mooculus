...
\begin{enumerate}
\item A point $(x,f(x))$ is a \textbf{local maximum}\index{maximum} if there is an interval $a<x<b$ with $f(x)\ge f(z)$ for
  every $z$ in $(a,b)$.
\item A point $(x,f(x))$ is a \textbf{local minimum}\index{minimum} if
  there is an interval $a<x<b$ with $f(x)\le f(z)$ for every $z$ in
  $(a,b)$.
\end{enumerate}
A \textbf{local extremum}\index{extremum} is either a local
...
\begin{fullwidth}
\begin{figure}\index{concave up/down}
