...
\begin{answer} min at $x=-2$ and at $x=0$
\end{answer}\end{exercise}
...
\begin{exercises}
\noindent In the following exercises, find all critical values and
...
be a maximum. 
\begin{answer} $f'(x) = 2ax + b$, this has only one root and hence one critical value; $a<0$ to guarantee a maximum.
\end{answer}
\end{exercise}
\end{exercises}
...
\]
Mark the critical values $x=2$ and $x=-1$ on your plot, see
...
\begin{tikzpicture}
	\begin{axis}[
        ...
        \end{axis}
\end{tikzpicture}
\caption{Now we add the critical values $x=-1$ and $x=2$.}
\label{figure:CS2}
\end{marginfigure}

Check the second derivative evaluated at the critical values. In this
case,
\[
...
\begin{exercise} $y= x^5 - x$
\begin{answer}
$y$-intercept at $(0,0)$; no vertical asymptotes; critical values:
...
\begin{answer}
$y$-intercept at $(0,0)$; no vertical asymptotes; no critical values;
...
\begin{answer}
$y$-intercept at $(0,0)$; no vertical asymptotes; critical values: $x=
...
\begin{answer}
$y$-intercept at $(0,5)$; no vertical asymptotes; critical values:
...
\begin{exercise} $y = x+ 1/x$
\begin{answer}
no $y$-intercept; vertical asymptote at $x=0$; critical values: $x=0$,
