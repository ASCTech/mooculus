...
indicating that there a many possible antiderivaties, each varying by
...
Let's put this rule and our knowlege of basic derivatives to work.
...
\]
Now check to see if you are correct. Rake the derivative of
$\cos(3x)$,
\[
\ddx \cos(3x) = -3\sin(3x).
\]
Ah, we are off by a factor of $-3$. Hence we should multiply our guess
by $1/-3$. We now find
\[
