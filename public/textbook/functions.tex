...
Give the inverse of $\l(t)$.  What does the inverse of $\l(t)$
 represent?
\begin{answer}
$t(\l) = \frac{3l}{8} - 3$, this function gives the number of months
...
\begin{answer}
$t(m) = \frac{m}{900} - \frac{1}/{3}$, this function gives the number of months
...
\being{answer}
\[
t(h) = 1 \mp \sqrt(1.4-0.2h).  Either function gives the time in terms of 
