...
\begin{exercise} Consider the following points:
\[
(-5,-2),\qquad (5,-1), \qquad(-4,0), \qquad(-4,-9), \qquad(4,10)
\]
Could these points all be on the graph of a function $y =f(x)$?
\begin{answer}
$5$
...
\begin{exercise} Let $f(x) = $, evaluate $f(0)$.
\begin{answer}
$5$
\end{answer}
\end{exercise}

\begin{exercise} Let $f(x) = $, evaluate $f(1)$.
\begin{answer}
$5$
\end{answer}
\end{exercise}
...
\begin{exercise} Let $f(x) = $, evaluate $f(h)$.
\begin{answer}
$5$
\end{answer}
\end{exercise}
...
\begin{exercise} Let $f(x) = $, evaluate $f(a+b)$.
\begin{answer}
$5$
\end{answer}
\end{exercise}
...
\begin{exercise} Let $f(x) = $, evaluate $f(x+h)$.
\begin{answer}
$5$
\end{answer}
\end{exercise}
