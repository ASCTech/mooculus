...
%% Balof
%% \exercise Find $\frac{dy}{dx}$ in each case both by Implicit
...
%% \exercise Describe the points on the unit circle, $x^2+y^2=1$, where we
%%   {\em cannot\/} define one variable in terms of the other.
%% 
%% \exercise Describe the points on the unit sphere, $x^2+y^2+z^2=1$, where
