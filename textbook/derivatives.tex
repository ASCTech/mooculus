...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(.8,1.6) (2.834,5)} \closedcycle; %% zoom fill
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(2.834,5) (4.166,5)} \closedcycle; %% zoom fill
          ...
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(3.3,3.6) (5.334,5)} \closedcycle; %% zoom fill
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(5.334,5) (6.666,5)} \closedcycle; %% zoom fill
          ...
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(3.7,2.4) (6.666,1)} \closedcycle; %% zoom fill
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(3.3,2.4) (3.7,2.4)} \closedcycle; %% zoom fill
          ...
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(.8,.4) (2.834,1)} \closedcycle; %% zoom fill
          \addplot [draw=none, fill=textColor!7!background] plot coordinates {(2.834,1) (4.166,1)} \closedcycle; %% zoom fill
