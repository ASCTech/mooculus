...
% \end{remark}
% 
% \exercise Illustrate the definition of concave up with a picture.
...
% 
% \exercise It can be shown that if $f$ is concave up on an open
...
% 
% 
% \exercise Let $f(x) = mx+b$. Show that $f$ is concave up
% and concave down.
% \label{exer:linear concavity} 
% 
% \exercise Let $\ds f(x) = ax^2 + bx +c$ with $a \neq 0$. Use the second
...
% 
% \exercise Give an example of a function $f$ on the interval $(-1,1)$ which is
% concave up but is not differentiable at $0$.
% 
% \exercise Let $f,g :I \to \R$ be concave up functions. Let $c\geq
% 0$. Show that $f+g$ and $cf$ are both concave up.
%  
% 
%  \exercise Let $f,g :I \to \R$ be concave up
